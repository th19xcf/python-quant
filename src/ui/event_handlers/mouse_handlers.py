...
class MouseHandler:
    ...
    def handle_mouse_moved(self, pos, dates, opens, highs, lows, closes):
        ...
        try:
            ...
            if 0 <= index < len(dates):
                ...
                if hasattr(self.main_window, 'kdj_values_label'):
                    ...
                    if current_indicator == "KDJ" and hasattr(self.main_window, 'current_kdj_data') and 0 <= index < len(self.main_window.current_kdj_data['k']):
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='white'>K: {current_k:.2f}</font>  <font color='yellow'>D: {current_d:.2f}</font>  <font color='magenta'>J: {current_j:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='blue'>RSI14: {current_rsi:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='#FFFFFF'>DIF: {current_macd:.2f}</font>  <font color='#FFFF00'>DEA: {current_macd_signal:.2f}</font>  <font color='{macd_hist_color}'>MACD: {current_macd_hist:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='white'>WR(10,6) </font><font color='yellow'>WR1: {current_wr1:.2f}</font> <font color='white'>WR2: {current_wr2:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='white'>MB: {current_mb:.2f}</font>  <font color='red'>UP: {current_up:.2f}</font>  <font color='#00FF00'>DN: {current_dn:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='#FFFFFF'>PDI: {current_pdi:.2f}</font>  <font color='#FFFF00'>NDI: {current_ndi:.2f}</font>  <font color='#FF00FF'>ADX: {current_adx:.2f}</font>  <font color='#00FF00'>ADXR: {current_adxr:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='#FFFFFF'>TRIX: {current_trix:.2f}</font>  <font color='#FFFF00'>MATRIX: {current_trma:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='#FFFF00'>BR: {current_br:.2f}</font>  <font color='#FFFFFF'>AR: {current_ar:.2f}</font>")
                        ...
                        self.main_window.kdj_values_label.setText(f"<font color='#FFFFFF'>VR: {current_vr:.2f}</font>  <font color='#FFFF00'>MAVR: {current_mavr:.2f}</font>")
            ...
            self.main_window.logger.exception(f"处理鼠标移动事件时发生错误: {e}")
        ...
        try:
            ...
            if event.double():  # 检查是否是双击
                ...
                if self.main_window.crosshair_enabled:
                    self.main_window.logger.info("双击K线图，启用十字线和信息框")
                    # 如果当前有K线数据，显示十字线
                    ...
                    self.main_window.logger.info("双击K线图，禁用十字线和信息框")
                    # 隐藏K线图十字线
            ...
            self.main_window.logger.exception(f"处理鼠标点击事件时发生错误: {e}")